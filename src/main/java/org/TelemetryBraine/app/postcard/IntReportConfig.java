...
public final class IntReportConfig extends Config<ApplicationId> {
     ...
     * @return the config
     */
    public org.onosproject.net.behaviour.inbandtelemetry.IntReportConfig setCollectorIp(IpAddress collectorIp) {
        return (org.onosproject.net.behaviour.inbandtelemetry.IntReportConfig) setOrClear(COLLECTOR_IP, collectorIp.toString());
    }
     ...
     * @return the config
     */
    public org.onosproject.net.behaviour.inbandtelemetry.IntReportConfig setCollectorPort(TpPort port) {
        return (org.onosproject.net.behaviour.inbandtelemetry.IntReportConfig) setOrClear(COLLECTOR_PORT, port.toInt());
    }
     ...
     * @return the config
     */
    public org.onosproject.net.behaviour.inbandtelemetry.IntReportConfig setMinFlowHopLatencyChangeNs(int ns) {
        return (org.onosproject.net.behaviour.inbandtelemetry.IntReportConfig) setOrClear(MIN_FLOW_HOP_LATENCY_CHANGE_NS, ns);
    }
     ...
     * @return the config
     */
    public org.onosproject.net.behaviour.inbandtelemetry.IntReportConfig setCollectorNextHopMac(MacAddress collectorNextHopMac) {
        return (org.onosproject.net.behaviour.inbandtelemetry.IntReportConfig) setOrClear(COLLECTOR_NEXT_HOP_MAC, collectorNextHopMac.toString());
    }
     ...
     * @return the config
     */
    public org.onosproject.net.behaviour.inbandtelemetry.IntReportConfig setSinkIp(IpAddress sinkIp) {
        return (org.onosproject.net.behaviour.inbandtelemetry.IntReportConfig) setOrClear(SINK_IP, sinkIp.toString());
    }
     ...
     * @return the config
     */
    public org.onosproject.net.behaviour.inbandtelemetry.IntReportConfig setSinkMac(MacAddress sinkMac) {
        return (org.onosproject.net.behaviour.inbandtelemetry.IntReportConfig) setOrClear(SINK_MAC, sinkMac.toString());
    }
     ...
     * @return the config
     */
    public org.onosproject.net.behaviour.inbandtelemetry.IntReportConfig setWatchSubnets(Set<IpPrefix> subnets) {
        return (org.onosproject.net.behaviour.inbandtelemetry.IntReportConfig) setOrClear(WATCH_SUBNETS, subnets);
    }
}
